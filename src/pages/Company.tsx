  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <div className="flex flex-col tb:flex-row items-center justify-between bg-[#F3F6FA] px-[10%]">
        <div className="flex flex-col w-full  py-[64px]">
          ...
          <p className="text-[#666666] text-[16px] mb-4">
            Transcend big data problems by creating solutions that are
            consistently evolving. We are founded on principles of
      ...
      <div className="flex flex-col items-center w-full bg-[#fff] py-[64px]">
        ...
        <p className=" text-center text-[#666666]">
          Our main goal is to provide you with more innovative and high
          efficiency database solutions, as well as <br /> a better operational
          environment void from complications and risks.
        </p>
      </div>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between bg-[#022ea9] py-[50px] px-[10%]">
        <div className="flex flex-col  w-full  text-[#fff] py-[64px] sm:w-[49%]">
          ...
          <p className=" text-[#fff]">
            We provide users with essential solutions for valuable insights to
            business. Try our fully-featured and enterprise-ready solutions.
            Download now !
          </p>
        </div>
